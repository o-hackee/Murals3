...
object MuralPois {
    ...
    val data: List<MuralPoi> by lazy {
        listOf(
            ...
            MuralPoi(LatLng(48.19801628385311, 16.3812507364243), "https://www.facebook.com/viennamurals/photos/pcb.2923721774619357/2923714841286717/?type=3", "just was on PDF 3")
        )
    }
}